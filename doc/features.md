...
- Built-in Properties<br>:heavy_check_mark: Current Working Folder<br>
	:heavy_check_mark: Current Script Folder<br>
	:heavy_check_mark: Current Tool Folder<br>:heavy_check_mark: Parent Script Folder<br>
...
- KList Type<br>
	...
	:heavy_check_mark: Copy Constructor to duplicate a KList<br>
...
- Sharing API<br>
	...
	:heavy_check_mark: Object property caster for different types<br>
...
- Folders API<br>
	...
	:heavy_check_mark: Get current script folder<br>:heavy_check_mark: Get parent script folder<br>:heavy_check_mark: Folder stack, push/pop <br>
...
- Tool execution<br>
	:heavy_check_mark: Execute a process (simple, fetching only exit code)<br>:x: Execute a process using shell<br>
