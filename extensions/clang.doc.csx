...
/// <summary>
/// Provides functionality for generating, organizing, and saving documentation from Clang-generated YAML files,
/// including support for filtering by namespaces, paths, and customizing output formatting.
/// </summary>
/// <remarks>The ClangDocs class is designed to automate the process of generating Markdown documentation from
/// Clang's YAML output. It supports filtering which symbols and namespaces are included, customizing headers, footers,
/// and images, and manages the output structure for documentation files. The class is intended for use in documentation
/// generation workflows where integration with Clang tooling and flexible output control are required. Thread safety is
/// not guaranteed; concurrent access to static members should be externally synchronized if used in multi-threaded
/// scenarios.</remarks>
class ClangDocs {

	/// <summary>
	/// Represents a documentation file generated from Clang source code, including metadata such as name, type, location,
	/// and associated documentation content.
	/// </summary>
	/// <remarks>This class is typically used to store and transfer information about a code element (such as a
	/// class, struct, or namespace) and its generated documentation. The fields provide details necessary for organizing,
	/// saving, and processing documentation files, including the original source location and the generated output path.
	/// All fields are public for direct access and assignment.</remarks>
	class ClangDocFile {
	...
	// to resolve paths in the documentation
	//
	//
